...
export function renderNav({ currentPage = 'home', basePath = '.' } = {}) {
  ...
  const SIDEBAR_ITEMS = {
    home: [
      ...
      { href: `${basePath}/components/ai-text.html`, text: '<ai-text>', page: 'ai-text', code: true },
      { href: `${basePath}/components/ai-markdown.html`, text: '<ai-markdown>', page: 'ai-markdown', code: true },
    ...
    'ai-text': 'componentSidebar',
    'ai-markdown': 'componentSidebar',
