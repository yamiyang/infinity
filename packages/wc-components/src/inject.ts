// ============================================================
// inject.ts — Build injectable script strings for iframe injection
//
// Usage in parent frame:
//   import { buildWCScript } from "wc-components/inject";
//   iframe.contentDocument.write(`<script>${buildWCScript()}<\/script>`);
//
// This is the equivalent of Infinity's buildComponentScript().
// The output is a self-contained JS string with NO import dependencies.
// ============================================================
 ...
 */
export function buildWCScript(): string {
  return `
(function() {
  "use strict";
 ...
 */
export function buildWCRegistryScript(): string {
  return `
(function() {
